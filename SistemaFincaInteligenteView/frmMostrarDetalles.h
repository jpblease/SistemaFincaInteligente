...
namespace SistemaFincaInteligenteView {
	...
	/// <summary>
	/// Resumen de frmMostrarDetalles
	/// </summary>
	public ref class frmMostrarDetalles : public System::Windows::Forms::Form
	{
	public:
		frmMostrarDetalles(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(frmMostrarDetalles::typeid));
			...
			this->pictureBox1->Size = System::Drawing::Size(1065, 586);
			...
			this->groupBox2->Location = System::Drawing::Point(66, 241);
			...
			this->button4->Location = System::Drawing::Point(653, 216);
			this->button4->Name = L"button4";
			this->button4->Size = System::Drawing::Size(148, 45);
			this->button4->TabIndex = 3;
			this->button4->Text = L"Eliminar";
			this->button4->UseVisualStyleBackColor = false;
			this->button4->Click += gcnew System::EventHandler(this, &frmMostrarDetalles::button4_Click);
			// 
			// button3
			// 
			...
			this->button3->Location = System::Drawing::Point(402, 216);
			...
			this->button2->Location = System::Drawing::Point(173, 216);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(135, 45);
			this->button2->TabIndex = 1;
			this->button2->Text = L"Nuevo";
			this->button2->UseVisualStyleBackColor = false;
			this->button2->Click += gcnew System::EventHandler(this, &frmMostrarDetalles::button2_Click);
			// 
			// dataGridView1
			// 
			...
			// Column3
			// 
			this->Column3->HeaderText = L"Parentesco";
			...
			this->groupBox1->Location = System::Drawing::Point(66, 64);
			...
			this->comboBox1->Location = System::Drawing::Point(459, 30);
			...
			this->label2->Location = System::Drawing::Point(376, 38);
			...
			this->button1->Click += gcnew System::EventHandler(this, &frmMostrarDetalles::button1_Click);
			// 
			// textBox1
			// 
			...
			this->ClientSize = System::Drawing::Size(1065, 586);
			this->Controls->Add(this->groupBox2);
			this->Controls->Add(this->groupBox1);
			this->Controls->Add(this->pictureBox1);
			this->Name = L"frmMostrarDetalles";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Mostrar Detalles";
			this->Load += gcnew System::EventHandler(this, &frmMostrarDetalles::frmMostrarDetalles_Load);
...
#pragma endregion
	private: System::Void frmMostrarDetalles_Load(System::Object^ sender, System::EventArgs^ e) {
		...
		for (int i = 0; i < listaOperarios->Count; i++) {         /*Recorremosv toda la lista*/
			this->comboBox1->Items->Add((listaOperarios[i]->getNombre()) );
			//this->comboBox1->Items->Add((listaOperarios[i]->getNombre())+(listaOperarios[i]->getApellidoP()));
			//this->comboBox1->Items->Add(listaOperarios[i]->getApellidoP());
		}
	}
    private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	
	  FamiliaController^ objFamiliaController = gcnew FamiliaController();
	  List<Familia^>^ listaFamilias;
	 if (this->comboBox1->Text != "") {
		String^ nombreOperario = this->comboBox1->Text; 
		listaFamilias = objFamiliaController->buscarFamiliaxOperario(nombreOperario);
		mostrarGrilla(listaFamilias); 
	}
    }

	 private: void mostrarGrilla(List<Familia^>^ listaFamilias) {
		   this->dataGridView1->Rows->Clear(); /*Elimino toda la informacion del datagrid*/
		   for (int i = 0; i < listaFamilias->Count; i++) {
			   Familia^ objFamilia = listaFamilias[i];
			   array<String^>^ filaGrilla = gcnew array<String^>(4);
			   filaGrilla[0] = Convert::ToString(objFamilia->getCodigo());
			   filaGrilla[1] = objFamilia->getNombre();
			   filaGrilla[2] = objFamilia->getParentesco();
			   filaGrilla[3] = Convert::ToString(objFamilia->getTelefono());
...
private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	int codigoFamiliaEliminar = Convert::ToInt32(this->dataGridView1->Rows[filaSeleccionada]->Cells[0]->Value->ToString());
	FamiliaController^ objFamiliaController = gcnew FamiliaController();
	objFamiliaController->eliminarFamilia(codigoFamiliaEliminar); 
	MessageBox::Show("El familiar ha sido eliminado con éxito");
	this->Close();
}
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	frmNuevoFamiliar^ ventanaNuevoFamiliar = gcnew frmNuevoFamiliar();
	ventanaNuevoFamiliar->ShowDialog();
}
};
}
