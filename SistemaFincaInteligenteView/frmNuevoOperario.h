...
namespace SistemaFincaInteligenteView {
	...
	/// <summary>
	/// Resumen de frmNuevoOperario
	/// </summary>
	public ref class frmNuevoOperario : public System::Windows::Forms::Form
	{
	public:
		frmNuevoOperario(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(frmNuevoOperario::typeid));
			...
			this->pictureBox1->Size = System::Drawing::Size(941, 588);
			...
			this->groupBox1->Location = System::Drawing::Point(75, 28);
			this->groupBox1->Name = L"groupBox1";
			this->groupBox1->Size = System::Drawing::Size(819, 528);
			this->groupBox1->TabIndex = 1;
			this->groupBox1->TabStop = false;
			this->groupBox1->Text = L"Datos del nuevo operario:";
			// 
			// textBox6
			// 
			this->textBox6->Location = System::Drawing::Point(180, 324);
			this->textBox6->Name = L"textBox6";
			this->textBox6->Size = System::Drawing::Size(136, 22);
			this->textBox6->TabIndex = 15;
			this->textBox6->TextChanged += gcnew System::EventHandler(this, &frmNuevoOperario::textBox6_TextChanged);
			// 
			// label7
			// 
			this->label7->AutoSize = true;
			this->label7->Location = System::Drawing::Point(28, 330);
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(180, 275);
			this->textBox5->Name = L"textBox5";
			this->textBox5->Size = System::Drawing::Size(136, 22);
			this->textBox5->TabIndex = 13;
			this->textBox5->TextChanged += gcnew System::EventHandler(this, &frmNuevoOperario::textBox5_TextChanged);
			this->textBox5->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &frmNuevoOperario::textBox5_KeyPress);
			// 
			// label6
			// 
			this->label6->AutoSize = true;
			this->label6->Location = System::Drawing::Point(28, 281);
			...
			this->dateTimePicker1->Location = System::Drawing::Point(177, 382);
			...
			this->label5->Location = System::Drawing::Point(28, 382);
			...
			this->button2->Location = System::Drawing::Point(452, 458);
			...
			this->button2->Click += gcnew System::EventHandler(this, &frmNuevoOperario::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Location = System::Drawing::Point(249, 458);
			...
			this->button1->Click += gcnew System::EventHandler(this, &frmNuevoOperario::button1_Click);
			// 
			// textBox4
			// 
			...
			this->textBox4->TextChanged += gcnew System::EventHandler(this, &frmNuevoOperario::textBox4_TextChanged);
			// 
			// label4
			// 
			...
			this->textBox3->TextChanged += gcnew System::EventHandler(this, &frmNuevoOperario::textBox3_TextChanged);
			// 
			// label3
			// 
			...
			this->textBox2->TextChanged += gcnew System::EventHandler(this, &frmNuevoOperario::textBox2_TextChanged);
			// 
			// label2
			// 
			...
			this->textBox1->TextChanged += gcnew System::EventHandler(this, &frmNuevoOperario::textBox1_TextChanged);
			// 
			// label1
			// 
			...
			this->groupBox2->Location = System::Drawing::Point(419, 46);
			this->groupBox2->Name = L"groupBox2";
			this->groupBox2->Size = System::Drawing::Size(361, 204);
			this->groupBox2->TabIndex = 18;
			this->groupBox2->TabStop = false;
			this->groupBox2->Text = L"Creacion de cuenta-trabajador:";
			// 
			// comboBox1
			// 
			...
			this->ClientSize = System::Drawing::Size(941, 588);
			this->Controls->Add(this->groupBox1);
			this->Controls->Add(this->pictureBox1);
			this->Name = L"frmNuevoOperario";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Nuevo Operario";
			this->Load += gcnew System::EventHandler(this, &frmNuevoOperario::frmNuevoOperario_Load);
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	//int codigo = numero;
	int codigo = Convert::ToInt32(this->textBox1->Text);/*Escribimos en la pantalla*/
	...
	//int existe = objOperarioController->existeOperario(codigo);

	/*
	if (existe) {
		MessageBox::Show("Ya existe un operario registrada con el codigo: " + codigo);
	}
	else {


		objOperarioController->registrarOperario(codigo, nombre, apellidoP, apellidoM, telefono, direccion);
		MessageBox::Show("El nuevo operario ha sido creado correctamente ");
		this->Close();
	...
	//Operario^ objOperarioAgregar = gcnew Operario(usuario, contrasena, nombre, apellidoP, apellidoM, telefono, direccion, tipodeusuario);
	//OperarioController^ objOperarioController = gcnew OperarioController();
	//objOperarioController->agregarTrabajador(objOperarioAgregar);

	OperarioController^ objOperarioController = gcnew OperarioController();
	if (objOperarioController->validarExisteUsuarioPropietario(usuario) == 1) {
		MessageBox::Show("El usuario-operario ya se encuentra aperturado ingrese otro usuario");
	}
	else {
		Operario^ objOperarioAgregar = gcnew Operario(usuario, contrasena, nombre, apellidoP, apellidoM, telefono, direccion, tipodeusuario); 
		objOperarioController->agregarTrabajador(objOperarioAgregar);  
		MessageBox::Show("El operario ha sido creado");
	}
}
private: System::Void frmNuevoOperario_Load(System::Object^ sender, System::EventArgs^ e) {
...
private:System::Void PueddeGuardar() {
