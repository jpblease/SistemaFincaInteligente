#pragma once
#include"frmMenuOperario.h"
#include"frmPantallaInicioOperario.h"
...
namespace SistemaFincaInteligenteView {
	...
	/// <summary>
	/// Resumen de frmSeguridadOperario
	/// </summary>
	public ref class frmSeguridadOperario : public System::Windows::Forms::Form
	{
	public:
		frmSeguridadOperario(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(frmSeguridadOperario::typeid));
			...
			this->pictureBox1->Size = System::Drawing::Size(915, 465);
			...
			this->groupBox1->Location = System::Drawing::Point(423, 12);
			this->groupBox1->Name = L"groupBox1";
			this->groupBox1->Size = System::Drawing::Size(446, 228);
			...
			this->pictureBox3->Location = System::Drawing::Point(21, 89);
			...
			this->textBox2->TextChanged += gcnew System::EventHandler(this, &frmSeguridadOperario::textBox2_TextChanged);
			// 
			// textBox1
			// 
			...
			this->button3->Location = System::Drawing::Point(319, 182);
			...
			this->button3->Click += gcnew System::EventHandler(this, &frmSeguridadOperario::button3_Click);
			// 
			// button2
			// 
			...
			this->button2->Location = System::Drawing::Point(182, 182);
			...
			this->button2->Click += gcnew System::EventHandler(this, &frmSeguridadOperario::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Location = System::Drawing::Point(30, 182);
			...
			this->button1->Click += gcnew System::EventHandler(this, &frmSeguridadOperario::button1_Click);
			// 
			// label2
			// 
			...
			this->label2->Location = System::Drawing::Point(77, 103);
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label1->Location = System::Drawing::Point(76, 55);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(64, 18);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Usuario:";
			this->label1->Click += gcnew System::EventHandler(this, &frmSeguridadOperario::label1_Click);
			// 
			// frmSeguridadOperario
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(8, 16);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(915, 465);
			this->Controls->Add(this->groupBox1);
			this->Controls->Add(this->pictureBox1);
			this->Name = L"frmSeguridadOperario";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Seguridad Operario";
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		/*
		if (((usuario == "luissedano") && (contrasena == "sedano")) || ((usuario2 == "juan") && (contrasena2 == "juan"))) {
			frmMenuOperario^ ventanaMenuOperario = gcnew frmMenuOperario();

			ventanaMenuOperario->Show();
		 }
		else {
		...
		if (objOperarioController->existeUsuarioOperario(usuario, contrasena) == 1) {
